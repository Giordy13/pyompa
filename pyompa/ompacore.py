...
class OMPAProblem(object):
    ...
    # Add the new density-dependent constraint
	    ...
	    # Assuming the order of water masses is [AW, LIW, WMDW]
            ...
            # Define transitions for both boundaries
            aw_limit = 33.385    # Above this, no AW
            liw_wmdw_transition = 33.445  # LIW-WMDW transition boundary
            wmdw_limit = 33.445    # Below this, no WMDW
   
            # Define transition margins
            aw_liw_margin = 1    # Margin for AW-LIW transition
            liw_wmdw_margin = 3  # Margin for LIW-WMDW transition
